...
export const projects: FilmProject[] = [
    {
        ...
        more: `Cut off from communication and confronted with evidence suggesting nuclear war has begun, three senior officers must decide whether to authorize a retaliatory nuclear launch.`,
        runtime: "3 min",
        music: "Original score by Vikas Banerjee Murthy",
        drive: "https://drive.google.com/drive/folders/180eHw-Fe-sst_SA_rxv9fx44QEAWqyoG",
        featured: true,
    },
    {
